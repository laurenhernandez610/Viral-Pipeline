// SIR Model
// Spread of disease is dependent on S,I and R 
// Total population doesn't change
// Recovered = Removed = Immunity/Death
// S + I + R = 1 ( 100% of Population)
// 


// Parameters
I0 = 0.0001; //Initial proportion infected
a = 1.1; // Infected Coefficient in weeks ^-1 
b = 0.2; // Removal Coefficient in weeks^-1
